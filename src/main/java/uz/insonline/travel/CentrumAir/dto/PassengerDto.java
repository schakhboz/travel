...
@Schema(description = "Passenger information – separate from insurant")
public record PassengerDto(
        ...
        @Schema(description = "First name", example = "Ivanon", requiredMode = Schema.RequiredMode.REQUIRED)
        ...
        @Schema(description = "PINFL (personal identification number)", example = "325625165487854")
        @Pattern(regexp = "\\d{14}", message = "PINFL must consist of 14 digits")
        String pinfl,

        @Schema(description = "Email address", example = "ivanov@example.com")
